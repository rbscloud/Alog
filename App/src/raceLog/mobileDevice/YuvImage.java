 ...
 * ImageFormat.NV21 and ImageFormat.YUY2 are supported. To compress a rectangle
 * region in the YUV data, users have to specify the region by left, top, width
 * and height.
 */
public class YuvImage {
	 ...
	 * @throws IllegalArgumentException if format is not support; width or
	 *             height <= 0; or yuv is null.
	 */
	 ...
	 * 
	 * @param rectangle The rectangle region to be compressed. The medthod
	 *            checks if rectangle is inside the image. Also, the method
	 *            modifies rectangle if the chroma pixels in it are not matched
	 *            with the luma pixels in it.
	 * @param quality Hint to the compressor, 0-100. 0 meaning compress for
	 *            small size, 100 meaning compress for max quality.
	 * @param stream OutputStream to write the compressed data.
	 * @return True if the compression is successful.
	 * @throws IllegalArgumentException if rectangle is invalid; quality is not
	 *             within [0, 100]; or stream is null.
	 */
	public boolean compressToJpeg(Rect rectangle, int quality, OutputStream stream) {
		...
		return nativeCompressToJpeg(mData, mFormat, rectangle.width(), rectangle.height(), offsets, mStrides, quality,
	...
	private static native boolean nativeCompressToJpeg(byte[] oriYuv, int format, int width, int height, int[] offsets,
