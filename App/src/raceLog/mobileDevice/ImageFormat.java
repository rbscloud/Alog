...
public class ImageFormat {
	 ...
	 * height's next multiple of two. y_size = stride * ALIGN(height, 2) c_size
	 * = ALIGN(stride/2, 16) * height size = y_size + c_size * 2 cr_offset =
	 * y_size cb_offset = y_size + c_size Whether this format is supported by
	 * the camera hardware can be determined by
